...
global const $kTipText[$kParamCount] = [ _
	...
	"8. Укажите левую-верхнюю точку на полоске MP цели (выделите себя или пета)", _
	"9. Укажите правую-нижнюю точку на полоске MP цели (выделите себя или пета)", _	
	"10. Укажите точку на полной полоске MP цели с характерным цветом (выделите себя или пета)", _	
	"11. Укажите точку на пустой полоске MP цели с характерным цветом (выделите себя или пета)", _		
