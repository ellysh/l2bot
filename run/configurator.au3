...
global const $kTipText[$kParamCount] = [ _
	...
	"Укажите точку на пустой полоске MP цели с характерным цветом (выделите себя или пета)", _		
 	"Укажите левую-верхнюю точку на полоске HP игрока", _
 	"Укажите правую-нижнюю точку на полоске HP игрока", _	
	"Укажите точку на полной полоске HP игрока с характерным цветом", _	
	"Укажите левую-верхнюю точку на полоске MP игрока", _
	"Укажите правую-нижнюю точку на полоске MP игрока", _
	"Укажите точку на полной полоске MP игрока с характерным цветом" _	
]
