...
func SendMessage()
	...
	SendSplitTextRus("Yjdsq ,jn ")
	SendSplitText("Lineage 2: ")
	SendSplitTextRus("afhv? hs,fkrf? xfn? vyjujjrjyyjcnm")
	SendSplitText(" - vk.com/l2bot | play4relax.ru")
...
func IsNickSelected()
	...
	LogWrite("IsNickSelected() - left[0] = " & $left[0] & " left[1] = " & $left[1])
