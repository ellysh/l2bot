...
3. Выполняйте произвольные нажатия клавишь и мыши.
4. Нажмите Alt+F1 для завершения скрипта генерации.

ВНИМАНИЕ: Скрипт генерации может запоминать нажатия букв латинского алфавита, клавиши F1-F12, нажатия левой кнопки мыши. Он не запоминает нажатия клавиш Alt, Ctrl, Shift, Win.
